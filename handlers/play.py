...
async def play(_, message: Message):
    ...
    try:
        ...
        user.first_name = "parliamentAsistant"
    usar = user
    wew = usar.id
    try:
    ...
    if audio:
        ...
        [
            [
                InlineKeyboardButton("🚀 İnfo", url=f"https://t.me/parliamentmuzikbot"),
                InlineKeyboardButton("📣 Kanal", url=f"https://t.me/trparliamenttt"),
            ],[
